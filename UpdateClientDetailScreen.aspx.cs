...
public partial class UpdateClientDetailScreen : System.Web.UI.Page
{
    ...
    protected void updateBtn_Click(object sender, EventArgs e)
    {
        ...
        string query = "UPDATE BookingsTable set clientName = '" + tbClientName.Text.ToString() + "' , clientMobile = '" + tbClientMobile.Text.ToString() + "' , clientAddress = '" + tbClientAddress.Text.ToString() + "' where bookingCode = '" + bookingCode.ToString() + "'";
